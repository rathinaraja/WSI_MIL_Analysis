...
def process_ViT_PMT_CLU(args):
    ...
    # Create a compatible args object for the model
    model_args = EasyDict({
        'in_dim': args.Model.in_dim,
        'emb_dim': args.Model.emb_dim,
        'n_layers': args.Model.n_layers,
        'cluster_number': args.Model.cluster_number,
        'momentum': args.Model.momentum,
        'moving_pmt': args.Model.moving_pmt,
        'merge_token': args.Model.merge_token
    })
    
    # Initialize ViT_PMT_CLU model
    ...
    print('Model Ready!')
    print(f'ViT_PMT_CLU Configuration:')
    print(f'  - Input Dim: {model_args.in_dim}')
    print(f'  - Embedding Dim: {model_args.emb_dim}')
    print(f'  - Transformer Layers: {model_args.n_layers}')
    print(f'  - PMT Clustering: True')
    print(f'  - Number of Clusters: {model_args.cluster_number}')
    print(f'  - Momentum: {model_args.momentum}')
