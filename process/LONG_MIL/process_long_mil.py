...
def process_LONG_MIL(args):
    ...
    train_dataset = LONG_MIL_WSI_Dataset(args.Dataset.dataset_csv_path,h5_csv_path,'train',args)
    val_dataset = LONG_MIL_WSI_Dataset(args.Dataset.dataset_csv_path,h5_csv_path,'val',args)
    test_dataset = LONG_MIL_WSI_Dataset(args.Dataset.dataset_csv_path,h5_csv_path,'test',args)
