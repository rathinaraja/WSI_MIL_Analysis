...
def process_SC_MIL(args):
    ...
    train_dataset = SC_MIL_WSI_Dataset(args.Dataset.dataset_csv_path, h5_csv_path, 'train', args, use_dummy_coords=use_dummy_coords)
    val_dataset = SC_MIL_WSI_Dataset(args.Dataset.dataset_csv_path, h5_csv_path, 'val', args, use_dummy_coords=use_dummy_coords)
    test_dataset = SC_MIL_WSI_Dataset(args.Dataset.dataset_csv_path, h5_csv_path, 'test', args, use_dummy_coords=use_dummy_coords)
