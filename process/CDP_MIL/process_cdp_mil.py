...
def process_CDP_MIL(args):
    ...
    train_dataset = CDP_MIL_WSI_Dataset(args.Dataset.dataset_csv_path,BayesianGaussian_pt_dir,'train',args)
    val_dataset = CDP_MIL_WSI_Dataset(args.Dataset.dataset_csv_path,BayesianGaussian_pt_dir,'val',args)
    test_dataset = CDP_MIL_WSI_Dataset(args.Dataset.dataset_csv_path,BayesianGaussian_pt_dir,'test',args)
