...
def process(args,yaml_path,options):
    ...
    if args.General.MODEL_NAME == 'MEAN_MIL':
        ...
        process_AC_MIL(args)
    elif args.General.MODEL_NAME in ['MAMBA_MIL', 'BiMAMBA_MIL','SRMAMBA_MIL']:
        from .MAMBA_MIL.process_mamba_mil import process_MAMBA_MIL
        process_MAMBA_MIL(args)
    elif args.General.MODEL_NAME == 'PTC_MIL':
        from .PTC_MIL.process_ptc_mil import process_ViT_PMT_CLU
        process_ViT_PMT_CLU(args)
    elif args.General.MODEL_NAME == 'DeepAttn_MIL':
