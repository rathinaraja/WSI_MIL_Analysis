...
# FEATURE_DIR="/data_64T_3/Raja/MUFASA/VISUALIZATION/TRIDENT/Extracted_features/resnet50_1024"
# COORDS_DIR="/data_64T_3/Raja/MUFASA/VISUALIZATION/TRIDENT/Coordinates"
...
# CHECKPOINT="/home/rajaj/Project/7.WSI_Analysis_Experiments/1.WSI_Classification/logs/TRIDENT/CAMELYON16/CLAM_MB_MIL/resnet50_1024/time_2026-01-04-15-49_CAMELYON16_CLAM_MB_MIL_seed_2023_resnet50_1024/fold_1/Best_EPOCH_33.pth" 
# WSI_LIST=("tumor_063" "tumor_071" "tumor_079" "tumor_086")

# Fixed Paths
WSI_DIR="/data_64T_3/Dataset/TCGA_LUSC/images/Tumor_DX1"
FEATURE_DIR="/data_64T_3/Raja/MUFASA/EXTRACTED_TILES_FEATURES_COORDINATES/TRIDENT/Extracted_features/resnet50_1024"
COORDS_DIR="/data_64T_3/Raja/MUFASA/EXTRACTED_TILES_FEATURES_COORDINATES/TRIDENT/Coordinates"
BASE_OUTPUT_DIR="/data_64T_3/Raja/MUFASA/VISUALIZATION/TCGA_NSCLC/ATTENTION_MAPS"

# Model Settings
MODEL_NAME="CLAM_MB_MIL"
MODEL_CONFIG="configs/CLAM_MB_MIL.yaml"
CHECKPOINT="/home/rajaj/Project/7.WSI_Analysis_Experiments/1.WSI_Classification/logs/TRIDENT/TCGA_NSCLC/CLAM_MB_MIL/resnet50_1024/time_2026-01-08-02-41_TCGA_NSCLC_CLAM_MB_MIL_seed_42_resnet50_1024/fold_2/Best_EPOCH_144.pth" 
...
do
    ...
    OUTPUT_DIR="${BASE_OUTPUT_DIR}/${WSI_NAME}/TRIDENT"
